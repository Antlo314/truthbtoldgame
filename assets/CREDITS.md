...
All 3D assets are **CC0 (public domain)** — free for commercial use, no
attribution required. Credited anyway because they earned it.

| Source | Packs / models | Where used |
|---|---|---|
...
The `Textures/colormap.png` beside each Kenney folder is the shared palette
texture the GLBs reference — don't delete it.
